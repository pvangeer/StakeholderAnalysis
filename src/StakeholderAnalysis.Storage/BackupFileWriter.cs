...
namespace StakeholderAnalysis.Storage
{
    ...
    public class BackedUpFileWriter
    {
        ...
        private void Finish()
        {
            if (isTemporaryFileCreated) DeleteTemporaryFile();
        }
        ...
        private void Revert()
        {
            if (isTemporaryFileCreated) RestoreOriginalFile();
        }
        ...
        private void RemoveAlreadyExistingTemporaryFile()
        {
            if (File.Exists(temporaryFilePath))
                ...
                {
                    if (e is ArgumentException || e is IOException || e is NotSupportedException ||
        ...
        private void CreateNewTemporaryFile()
        {
            ...
            {
                if (e is ArgumentException || e is IOException || e is UnauthorizedAccessException ||
