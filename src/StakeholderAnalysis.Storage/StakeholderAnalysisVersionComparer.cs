...
namespace StakeholderAnalysis.Storage
{
    ...
    public class StakeholderAnalysisVersionComparer : IComparer, IComparer<string>
    {
        ...
        {
            if (x == null || y == null) return string.Compare(x, y, StringComparison.InvariantCulture);
            ...
            {
                if (secondVersionArray.Length < 1) return 0;
                return -1;
            }

            if (secondVersionArray.Length < 1) return 1;
