...
namespace StakeholderAnalysis.Storage
{
    ...
    public static class StringExtensions
    {
        ...
        public static string FirstToUpper(this string str)
        {
            ...
            if (str.Length > 1) return char.ToUpper(str[0], CultureInfo.CurrentCulture) + str.Substring(1);
        ...
        public static string FirstToLower(this string str)
        {
            ...
            if (str.Length > 1) return char.ToLower(str[0], CultureInfo.CurrentCulture) + str.Substring(1);
